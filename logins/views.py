...
#             login(request, user)
#             return redirect('paciente:paciente_dashboard')
#
# @login_required
# def out(request):
#     logout(request)
...
def register(request):
    ...
    return render(request, 'logins/../templates/pacientes/register.html', {'form': form})  # Renderizar la plantilla de registro
...
def paciente_dashboard(request):
    ...
    return render(request, 'pacientes/paciente_dashboard.html', {'recetas': recetas})
...
def schedule_appointment(request):
    ...
    return render(request, 'logins/../templates/pacientes/schedule_appointment.html')
